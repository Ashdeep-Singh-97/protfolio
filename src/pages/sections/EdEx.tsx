...
export default function EdEx() {
  ...
  const projectData = [
    {
      name: "MeetUp",
      deployment: "https://meetup-teal-tau.vercel.app/",
      github: "https://github.com/Ashdeep-Singh-97/meetup",
      summary: "An App which gives you a random place nearby you, Giving you a target to walk to."
    },
    {
      name: "ChatBot",
